            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="{{ asset('assets/admin') }}/#" class="small-box-footer">More info <i
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <ul class="nav nav-pills ml-auto">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{{ asset('assets/admin') }}/#revenue-chart"
                                            data-toggle="tab">Area</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ asset('assets/admin') }}/#sales-chart"
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <ul class="pagination pagination-sm">
                                    <li class="page-item"><a href="{{ asset('assets/admin') }}/#"
                            ...
                            <div class="card-tools">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a href="{{ asset('assets/admin') }}/#" class="dropdown-item">Add new
                                            event</a>
                                        <a href="{{ asset('assets/admin') }}/#" class="dropdown-item">Clear
                                            events</a>
                                        <div class="dropdown-divider"></div>
                                        <a href="{{ asset('assets/admin') }}/#" class="dropdown-item">View
                                            calendar</a>
                                    </div>
                                </div>
