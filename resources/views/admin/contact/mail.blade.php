            ...
            <td class="header container">
                ...
                <div class="content">
                    <table bgcolor="#999999">
                        <tr>
                            <td align="right">
                                <h6 class="collapse">Webdidong</h6>
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <h3>Chúng tôi xin được phản hồi lại với bạn như sau: </h3>
                                            ...
                                            <table align="left" class="column">
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p class="">
                                                            <a href="https://facebook.com/phuocbt698"
                                                                class="soc-btn fb">Facebook</a>
                                                            <a href="https://github.com/phuocbt698"
                                                                class="soc-btn git">Github</a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table><!-- /column 1 -->
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p>Phone: <strong>0975.041.697</strong><br />
                                                            Email: <strong><a
                                                                    href="emailto:phuocbt698@gmail.com">phuocbt698@gmail.com</a></strong>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table><!-- /column 2 -->
